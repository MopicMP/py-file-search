...
> Py recursive file search with glob patterns

[![PyPI version](https://badge.fury.io/py/py-file-search.svg)](https://pypi.org/project/py-file-search/)
...
```bash
pip install py-file-search
```

## Quick Start

```python
from py_file_search import search
...
from py_file_search import batch
